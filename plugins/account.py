...
@Bot.on_message(filters.command(['myaccount', 'account']) & filters.private,group = 27637762)
...
@Bot.on_callback_query(group=13453754365)
...
@Bot.on_message(filters.private & filters.text, group=7364736)
